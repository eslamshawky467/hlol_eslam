<x-admin title="الاسئله">
            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class=" float-md-right">
                        <a href="{{ route('settings.fqa.create') }}" class="btn btn-primary round btn-glow px-2"
                            type="button">انشاء سؤال جديد</a>
    ...
    <section id="html5">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">قائمه الاسئله</h4>
                    ...
                    <div class="card-content collapse show">
                        ...
                        <div class="card-body card-dashboard">
                            ...
                            <form action="{{ route('settings.fqa.delete.all') }}" method="POST">
                                @csrf
            ...
            @include('admin.settings.fqa.delete-modal')
        </div>
    </section>
    @push('css')
    ...
    @push('js')
        ...
        <script>
            $('#defaultSize').on('shown.bs.modal', function(event) {
                ...
                var setting_name = button.data('name')
                console.log(id);
                var modal = $(this)
                document.getElementById('setting_id').value = id;
                document.getElementById('setting_name').textContent = "  هل متاكد من حذف السؤال : " + setting_name

            });
        </script>
        <script language="JavaScript">
            function checkAll(source) {
                var ele = document.getElementsByName('settings_ids[]');
