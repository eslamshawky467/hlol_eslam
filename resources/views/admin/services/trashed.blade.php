<x-admin title="الخدمات المؤرشفه">
    <x-slot name="breadcrumbs">
        <div class="content-wrapper">
            <div class="content-header row">
                <x-bread-crumbs title="الخدمات المؤرشفه">

                </x-bread-crumbs>
                <div class="content-header-right col-md-6 col-12">
                    <div class=" float-md-right">
                        <a href="{{ route('services.create') }}" class="btn btn-primary round btn-glow px-2"
                            type="button">انشاء خدمه جديد</a>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">قائمه الخدمات المؤرشفه</h4>
                    ...
                    <div class="card-content collapse show">
                        ...
                        <div class="card-body card-dashboard">
                            ...
                            <form action="{{ route('services.all') }}" method="POST">
                                @csrf
                                <button type="submit" class="btn btn-outline-success ml-1 mb-3 float-lg-right"
                                    name="action" value="restore"> استعاده الكل </button>
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.banners-tabl').DataTable({
                    ...
                    ajax: "{{ route('services.archived.services') }}",
                    columns: [{
                            data: 'id',
                            name: 'id'
                        },
        ...
        <script>
            $('#defaultSize').on('shown.bs.modal', function(event) {
                ...
                document.getElementById('service_name_id').textContent = "  هل متاكد من حذف الخدمه : " + service_name

            });
        </script>
        <script language="JavaScript">
            function checkAll(source) {
                var ele = document.getElementsByName('services_ids[]');
